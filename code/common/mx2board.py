...
PERIPHERALS = \
    {
        ...
        "GPIO_Output": [PIN_MODE_OUTPUT, PIN_OTYPE_PUSHPULL, PIN_OSPEED_50M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                        PIN_AFIO_AF.format("{0}", 0)],
        ...
        "SWCLK": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_2M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                  PIN_AFIO_AF.format("{0}", 0)],
        "(RCC|SYS)_OSC": [PIN_MODE_INPUT, PIN_OTYPE_PUSHPULL, PIN_OSPEED_2M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                    PIN_AFIO_AF.format("{0}", 0)],
        "ADC": [PIN_MODE_ANALOG, PIN_OTYPE_PUSHPULL, PIN_OSPEED_2M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                PIN_AFIO_AF.format("{0}", 0)],
        "DAC": [PIN_MODE_ANALOG, PIN_OTYPE_PUSHPULL, PIN_OSPEED_2M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                PIN_AFIO_AF.format("{0}", 0)],
        "I2C[12]_S[CD]": [PIN_MODE_ALTERNATE, PIN_OTYPE_OPENDRAIN, PIN_OSPEED_50M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                   PIN_AFIO_AF.format("{0}", 1)],
        "SPI[12]": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_50M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                    PIN_AFIO_AF.format("{0}", 0)],
        "TIM[12]_CH[1-4]": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_50M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                    PIN_AFIO_AF.format("{0}", 2)],
        "TIM3_CH[1-4]": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_50M, PIN_PUPDR_PULLUP, PIN_ODR_HIGH,
                    PIN_AFIO_AF.format("{0}", 1)],
        "TIM14_CH": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_50M, PIN_PUPDR_PULLUP, PIN_ODR_HIGH,
                    PIN_AFIO_AF.format("{0}", 4)],
        "TIM15_CH": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_50M, PIN_PUPDR_PULLUP, PIN_ODR_HIGH,
                    PIN_AFIO_AF.format("{0}", 0)],
        "TIM(16|17)_CH": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_50M, PIN_PUPDR_PULLUP, PIN_ODR_HIGH,
                    PIN_AFIO_AF.format("{0}", 5)],
        "USART[12]_TX": [PIN_MODE_ALTERNATE, PIN_OTYPE_OPENDRAIN, PIN_OSPEED_50M, PIN_PUPDR_PULLUP, PIN_ODR_HIGH,
                   PIN_AFIO_AF.format("{0}", 1)],
        "USART[12]_RX": [PIN_MODE_ALTERNATE, PIN_OTYPE_OPENDRAIN, PIN_OSPEED_50M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                   PIN_AFIO_AF.format("{0}", 1)],
        "(RCC|SYS)_MCO": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_100M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                PIN_AFIO_AF.format("{0}", 0)],
    }
...
for l in lines:
    ...
    print "P"+port+str(pad), signals[port][pad] 
