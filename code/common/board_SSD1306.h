...
#define SSD1306_RESET_PIN			12
#define SSD1306_MISO_PORT		GPIOB
#define SSD1306_MISO_PIN			4
#define SSD1306_MOSI_PORT		GPIOB
#define SSD1306_MOSI_PIN			5
#define SSD1306_SCK_PORT			GPIOB
#define SSD1306_SCK_PIN			3
 ...
 * Speed 18MHz, CPHA=0, CPOL=0, 8bits frames, MSb transmitted first.
 * The slave select line is the pin 15 on the port GPIOA.
 */
